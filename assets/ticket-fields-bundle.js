import { s as styled, u as useTranslation, j as jsxRuntimeExports, F as FileList, a as File, T as Tooltip, P as Progress, A as Anchor, r as reactExports, b as Field, n as notify, c as useDropzone, d as FileUpload, I as Input$1, C as Checkbox$1, S as Span, e as sanitizeHtml, M as MediaInput, f as SvgCreditCardStroke, D as DatePicker$1, g as Textarea, h as Field$1, i as Combobox, O as Option, k as OptGroup, l as debounce } from 'shared';
...
function Checkbox({ field, onChange }) {
    ...
    return (jsxRuntimeExports.jsxs(Field, { children: [jsxRuntimeExports.jsx("input", { type: "hidden", name: name, value: "off" }), jsxRuntimeExports.jsxs(Checkbox$1, { name: name, required: required, defaultChecked: value, value: checkboxValue ? "on" : "off", onChange: handleChange, children: [jsxRuntimeExports.jsxs(Field.Label, { children: [label, required && jsxRuntimeExports.jsx(Span, { "aria-hidden": "true", children: "*" })] }), description && (jsxRuntimeExports.jsx(Field.Hint, { dangerouslySetInnerHTML: { __html: sanitizeHtml(description) } }))] }), error && (jsxRuntimeExports.jsx(Field.Message, { validation: "error", children: error }))] }));
}
...
function CreditCard({ field, onChange }) {
    ...
    return (jsxRuntimeExports.jsxs(Field, { children: [jsxRuntimeExports.jsxs(Field.Label, { children: [label, required && jsxRuntimeExports.jsx(Span, { "aria-hidden": "true", children: "*" }), jsxRuntimeExports.jsx(DigitsHintSpan, { children: t("cph-theme-ticket-fields.credit-card-digits-hint", "(Last 4 digits)") })] }), description && (jsxRuntimeExports.jsx(Field.Hint, { dangerouslySetInnerHTML: { __html: sanitizeHtml(description) } })), jsxRuntimeExports.jsx(MediaInput, { start: jsxRuntimeExports.jsx(SvgCreditCardStroke, {}), name: name, type: "text", value: digits, onChange: (e) => onChange(e.target.value), validation: error ? "error" : undefined, required: required, maxLength: 4, placeholder: "XXXX" }), error && (jsxRuntimeExports.jsx(Field.Message, { validation: "error", children: error }))] }));
}
...
function DatePicker({ field, locale, valueFormat, onChange, }) {
    ...
    return (jsxRuntimeExports.jsxs(Field, { children: [jsxRuntimeExports.jsxs(Field.Label, { children: [label, required && jsxRuntimeExports.jsx(Span, { "aria-hidden": "true", children: "*" })] }), description && (jsxRuntimeExports.jsx(Field.Hint, { dangerouslySetInnerHTML: { __html: sanitizeHtml(description) } })), jsxRuntimeExports.jsx(DatePicker$1, { value: date, onChange: handleChange, formatDate: formatDateInput, locale: locale, children: jsxRuntimeExports.jsx(Input$1, { required: required, lang: locale, onChange: handleInputChange, validation: error ? "error" : undefined }) }), error && (jsxRuntimeExports.jsx(Field.Message, { validation: "error", children: error })), jsxRuntimeExports.jsx("input", { type: "hidden", name: name, value: formatDateValue(date) })] }));
}
...
function TextArea({ field, hasWysiwyg, baseLocale, hasAtMentions, userRole, brandId, onChange, }) {
    ...
    return (jsxRuntimeExports.jsxs(StyledField, { children: [jsxRuntimeExports.jsxs(StyledField.Label, { children: [label, required && jsxRuntimeExports.jsx(Span, { "aria-hidden": "true", children: "*" })] }), description && (jsxRuntimeExports.jsx(StyledField.Hint, { dangerouslySetInnerHTML: { __html: sanitizeHtml(description) } })), jsxRuntimeExports.jsx(Textarea, { ref: ref, name: name, defaultValue: value, validation: error ? "error" : undefined, required: required, onChange: (e) => onChange(e.target.value), rows: 6, isResizable: true }), error && jsxRuntimeExports.jsx(StyledMessage, { validation: "error", children: error })] }));
}
