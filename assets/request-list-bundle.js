import { r as reactExports, u as useTranslation, j as jsxRuntimeExports, b as Field, M as MediaInput, a3 as SvgSearchStroke, s as styled, a4 as Menu, a5 as Field$1, a6 as useDownshiftEnvironment, a7 as Dropdown, a8 as Label, a9 as Autocomplete, aa as Item, E as Paragraph, Y as Alert, z as useModalContainer, w as Modal, C as Checkbox, A as Anchor, G as Button, Q as Dots, ab as Ne, ac as subDays, ad as formatISO, ae as subMonths, af as subYears, ag as Select, I as Input, ah as DatePickerRange, ai as Grid, aj as format, ak as Multiselect$2, t as Tag, U as Header, V as Body, W as Footer, R as FooterItem, X as Close, S as Span, al as upperFirst, am as isToday, an as isYesterday, T as Tooltip, ao as Ellipsis, ap as Table, aq as Trigger, ar as HeaderItem, as as SvgChevronDownStroke, at as Tabs, au as Skeleton, av as CursorPagination, Z as initI18next, _ as loadTranslations, aw as ReactDOM, ax as ShadowRootContainer, a1 as ThemeProviders, a2 as createTheme, ay as ErrorBoundary } from 'shared';
...
function RequestsSearch({ query, onSearchSubmit, }) {
    ...
    return (jsxRuntimeExports.jsx("form", { onSubmit: onSearchChange, children: jsxRuntimeExports.jsxs(Field, { "data-test-id": "requests-search", children: [jsxRuntimeExports.jsx(Field.Label, { hidden: true, children: t("guide-requests-app.searchField.Label", "Search") }), jsxRuntimeExports.jsx(MediaInput, { start: jsxRuntimeExports.jsx(SvgSearchStroke, { "aria-hidden": "true" }), ref: searchInputRef, type: "search", defaultValue: query })] }) }));
}
...
function OrganizationsDropdown({ organizations, currentOrganizationId, onOrganizationSelected, }) {
    ...
    return (jsxRuntimeExports.jsxs(Dropdown, { inputValue: inputValue, onInputValueChange: setInputValue, selectedItem: currentOrganizationId, onSelect: onSelect, downshiftProps: { environment: downshiftEnvironment }, children: [jsxRuntimeExports.jsxs(StyledField$1, { children: [jsxRuntimeExports.jsx(Label, { children: t("guide-requests-app.organization", "Organization") }), jsxRuntimeExports.jsx(Autocomplete, { "data-test-id": "organizations-menu", children: selectedOrganization?.name })] }), jsxRuntimeExports.jsx(StyledMenu$2, { placement: "bottom-start", children: organizations
...
const PushNotificationContext = reactExports.createContext(null);

function usePushNotification() {
    const pushNotification = reactExports.useContext(PushNotificationContext);
...
function FollowOrganizationsModal(props) {
    ...
    const updateSubscriptions = async () => {
        ...
        if (!updatedOrganizationSubscriptionState.some((oss) => oss.isError)) {
            pushNotification({
                type: "success",
                title: t("guide-requests-app.organizationSubscriptionUpdated", "Organization subscription updated"),
            });
            onClose();
        }
    };
...
function CheckboxFilter({ label, onSelect, errors, }) {
    ...
    return (jsxRuntimeExports.jsxs(Dropdown, { selectedItem: value, onSelect: handleSelect, downshiftProps: { environment: downshiftEnvironment }, children: [jsxRuntimeExports.jsxs(Field$1, { children: [jsxRuntimeExports.jsx(Label, { children: t("guide-requests-app.filters-modal.select-field-value", "Select {{field_name}}", {
                            field_name: label,
...
const FilterTypeDropdown = (props) => {
    ...
    const downshiftEnvironment = useDownshiftEnvironment();
    return (jsxRuntimeExports.jsxs(Dropdown, { onSelect: onFilterTypeSelect, selectedItem: selectedFilter, downshiftProps: { environment: downshiftEnvironment }, children: [jsxRuntimeExports.jsxs(Field$1, { children: [jsxRuntimeExports.jsx(Label, { children: t("guide-requests-app.filter-modal.filterTypeLabel", "Filter type") }), jsxRuntimeExports.jsx(StyledSelect, { validation: errors["filterType"] ? "error" : undefined, children: selectedFilter ? filterTypeDropdownI18N[selectedFilter] : "" }), jsxRuntimeExports.jsx(FieldError, { errors: errors, field: "filterType" })] }), jsxRuntimeExports.jsxs(ModalMenu, { children: [jsxRuntimeExports.jsx(Item, { value: "anyValue", children: filterTypeDropdownI18N.anyValue }), jsxRuntimeExports.jsx(Item, { value: "exactMatch", children: filterTypeDropdownI18N.exactMatch })] })] }));
};
...
function CustomDateFilter({ initialValues: [from, to], onChange, errors, allowFutureDates, className, }) {
    ...
    return (jsxRuntimeExports.jsx("div", { className: className, children: isMobile() ? (jsxRuntimeExports.jsxs(Container$5, { children: [jsxRuntimeExports.jsxs(Field, { children: [jsxRuntimeExports.jsx(Field.Label, { children: t("guide-requests-app.startDate", "Start") }), jsxRuntimeExports.jsx(Input, { type: "date", value: startValue
                                ...
                                ? undefined
                                : formatISO(new Date(), { representation: "date" }), onChange: handleEndDateChange, validation: errors.endDate ? "error" : undefined, required: true }), jsxRuntimeExports.jsx(FieldError, { errors: errors, field: "endDate" })] })] })) : (jsxRuntimeExports.jsx(DatePickerRange, { startValue: startValue, endValue: endValue, maxValue: allowFutureDates ? undefined : new Date(), onChange: handleDatePickerChange, locale: currentLocale, isCompact: true, children: jsxRuntimeExports.jsxs(Container$5, { children: [jsxRuntimeExports.jsxs(Grid.Row, { children: [jsxRuntimeExports.jsx(Grid.Col, { children: jsxRuntimeExports.jsxs(Field, { children: [jsxRuntimeExports.jsx(Field.Label, { children: t("guide-requests-app.startDate", "Start") }), jsxRuntimeExports.jsx(DatePickerRange.Start, { children: jsxRuntimeExports.jsx(Input, { "data-test-id": "custom-datepicker-start-date", validation: errors.startDate ? "error" : undefined }) }), jsxRuntimeExports.jsx(FieldError, { errors: errors, field: "startDate" })] }) }), jsxRuntimeExports.jsx(Grid.Col, { children: jsxRuntimeExports.jsxs(Field, { children: [jsxRuntimeExports.jsx(Field.Label, { children: t("guide-requests-app.endDate", "End") }), jsxRuntimeExports.jsx(DatePickerRange.End, { children: jsxRuntimeExports.jsx(Input, { "data-test-id": "custom-datepicker-end-date", validation: errors.endDate ? "error" : undefined }) }), jsxRuntimeExports.jsx(FieldError, { errors: errors, field: "endDate" })] }) })] }), jsxRuntimeExports.jsx(Grid.Row, { children: jsxRuntimeExports.jsx(Grid.Col, { children: jsxRuntimeExports.jsx(DatePickerRange.Calendar, { "data-test-id": "custom-datepicker" }) }) })] }) })) }));
}
...
function NumberFilter({ label, onSelect, errors, type, }) {
    ...
    const { filterTypeDropdownI18N } = useFilterTranslations();
    return (jsxRuntimeExports.jsxs(Container$4, { children: [jsxRuntimeExports.jsxs(Dropdown, { selectedItem: filter?.type, onSelect: handleFilterTypeSelect, downshiftProps: {
                    environment: downshiftEnvironment,
                }, children: [jsxRuntimeExports.jsxs(Field$1, { children: [jsxRuntimeExports.jsx(Label, { children: t("guide-requests-app.filter-modal.filterTypeLabel", "Filter type") }), jsxRuntimeExports.jsx(Select, { validation: errors.filterType ? "error" : undefined, children: filter ? filterTypeDropdownI18N[filter.type] : "" }), jsxRuntimeExports.jsx(FieldError, { errors: errors, field: "filterType" })] }), jsxRuntimeExports.jsxs(ModalMenu, { children: [jsxRuntimeExports.jsx(Item, { value: "anyValue", children: filterTypeDropdownI18N.anyValue }), jsxRuntimeExports.jsx(Item, { value: "range", children: filterTypeDropdownI18N.range }), jsxRuntimeExports.jsx(Item, { value: "exactMatch", children: filterTypeDropdownI18N.exactMatch })] })] }), filter?.type === "range" && (jsxRuntimeExports.jsxs(Grid.Row, { children: [jsxRuntimeExports.jsx(Grid.Col, { children: jsxRuntimeExports.jsxs(Field, { children: [jsxRuntimeExports.jsx(Field.Label, { children: t("guide-requests-app.filter-modal.minValue", "Min value") }), jsxRuntimeExports.jsx(Input, { type: "number", value: filter.minValue, onChange: (e) => {
...
function FilterTagWrapper({ field, values, onFilterRemoved, children, }) {
    ...
    return (jsxRuntimeExports.jsxs(Tag, { size: "large", isRegular: true, tabIndex: 0, onKeyDown: (e) => handleFilterKeyDown(e), children: [children, jsxRuntimeExports.jsx(Tag.Close, { "data-test-id": `remove-filter-${field}${values.join(" ")}`, onClick: () => onFilterRemoved() })] }, field));
}
...
function FilterTags({ filters, ticketFields, organizations, customStatusOptions, onFiltersChanged, }) {
    ...
    return (jsxRuntimeExports.jsxs(Container$3, { children: [Object.entries(filters).map(([field, values]) => {
            ...
            }), Object.keys(filters).length > 0 && (jsxRuntimeExports.jsx(Button, { isBasic: true, size: "small", "data-test-id": "button-clear-filters", onClick: () => onFiltersChanged({}), children: t("guide-requests-app.clearFilters", "Clear filters") }))] }));
}
...
function RequestsColumnFilter({ onSelectedColumnsChanged, selectedColumns, requestAttributes, defaultDesktopColumns, }) {
    ...
    return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsxs(Dropdown, { isOpen: isDropdownOpen, selectedItems: selectedColumns, onSelect: handleSelect, downshiftProps: {
                    environment: downshiftEnvironment,
                }, onStateChange: handleStateChange, children: [jsxRuntimeExports.jsx(Trigger, { children: jsxRuntimeExports.jsx(Table.OverflowButton, { "aria-label": t("guide-requests-app.column-selection.show-hide-columns", "Show and hide columns") }) }), jsxRuntimeExports.jsxs(StyledMenu$1, { placement: "bottom-end", popperModifiers: {
                            preventOverflow: {
...
function RequestsTabs({ selectedTab, organizations, onTabSelected, }) {
    ...
    return (jsxRuntimeExports.jsxs(Container, { children: [jsxRuntimeExports.jsx(Mobile, { children: jsxRuntimeExports.jsxs(Dropdown, { onSelect: handleMobileTabSelected, downshiftProps: { environment: downshiftEnvironment }, onStateChange: ({ isOpen }) => {
                        if (isOpen != null) {
        ...
        try {
            ...
            if (response.status === 406) {
                ...
                if (error.includes("Number of search words exceeds the limit")) {
                    pushNotification({
                        type: "error",
                        title: t("guide-requests-app.SearchPhraseIsTooLong", "Search phrase is too long. Try something shorter."),
                    });
                    push({ page: 1, query: "" });
                }
            }
...
function useTicketFields(locale) {
    ...
    async function fetchTicketFields() {
        try {
            ...
            setTicketFields(response.filter((ticketField) => ticketField.active || ticketField.type == "subject"));
            setIsLoading(false);
        }
        catch (error) {
            setError(error);
...
function useCustomStatuses(customStatusesEnabled) {
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case '../shared/translations/locales/af.json': return import('shared').then(function (n) { return n.a_; });
    case '../shared/translations/locales/ar-x-pseudo.json': return import('shared').then(function (n) { return n.a$; });
    case '../shared/translations/locales/ar.json': return import('shared').then(function (n) { return n.b0; });
    case '../shared/translations/locales/az.json': return import('shared').then(function (n) { return n.b1; });
    case '../shared/translations/locales/be.json': return import('shared').then(function (n) { return n.b2; });
    case '../shared/translations/locales/bg.json': return import('shared').then(function (n) { return n.b3; });
    case '../shared/translations/locales/bn.json': return import('shared').then(function (n) { return n.b4; });
    case '../shared/translations/locales/bs.json': return import('shared').then(function (n) { return n.b5; });
    case '../shared/translations/locales/ca.json': return import('shared').then(function (n) { return n.b6; });
    case '../shared/translations/locales/cs.json': return import('shared').then(function (n) { return n.b7; });
    case '../shared/translations/locales/cy.json': return import('shared').then(function (n) { return n.b8; });
    case '../shared/translations/locales/da.json': return import('shared').then(function (n) { return n.b9; });
    case '../shared/translations/locales/de-de.json': return import('shared').then(function (n) { return n.ba; });
    case '../shared/translations/locales/de-x-informal.json': return import('shared').then(function (n) { return n.bb; });
    case '../shared/translations/locales/de.json': return import('shared').then(function (n) { return n.bc; });
    case '../shared/translations/locales/el.json': return import('shared').then(function (n) { return n.bd; });
    case '../shared/translations/locales/en-001.json': return import('shared').then(function (n) { return n.be; });
    case '../shared/translations/locales/en-150.json': return import('shared').then(function (n) { return n.bf; });
    case '../shared/translations/locales/en-au.json': return import('shared').then(function (n) { return n.bg; });
    case '../shared/translations/locales/en-ca.json': return import('shared').then(function (n) { return n.bh; });
    case '../shared/translations/locales/en-gb.json': return import('shared').then(function (n) { return n.bi; });
    case '../shared/translations/locales/en-my.json': return import('shared').then(function (n) { return n.bj; });
    case '../shared/translations/locales/en-ph.json': return import('shared').then(function (n) { return n.bk; });
    case '../shared/translations/locales/en-se.json': return import('shared').then(function (n) { return n.bl; });
    case '../shared/translations/locales/en-us.json': return import('shared').then(function (n) { return n.bm; });
    case '../shared/translations/locales/en-x-dev.json': return import('shared').then(function (n) { return n.bn; });
    case '../shared/translations/locales/en-x-keys.json': return import('shared').then(function (n) { return n.bo; });
    case '../shared/translations/locales/en-x-obsolete.json': return import('shared').then(function (n) { return n.bp; });
    case '../shared/translations/locales/en-x-pseudo.json': return import('shared').then(function (n) { return n.bq; });
    case '../shared/translations/locales/en-x-test.json': return import('shared').then(function (n) { return n.br; });
    case '../shared/translations/locales/es-419.json': return import('shared').then(function (n) { return n.bs; });
    case '../shared/translations/locales/es-ar.json': return import('shared').then(function (n) { return n.bt; });
    case '../shared/translations/locales/es-cl.json': return import('shared').then(function (n) { return n.bu; });
    case '../shared/translations/locales/es-es.json': return import('shared').then(function (n) { return n.bv; });
    case '../shared/translations/locales/es-mx.json': return import('shared').then(function (n) { return n.bw; });
    case '../shared/translations/locales/es-pe.json': return import('shared').then(function (n) { return n.bx; });
    case '../shared/translations/locales/es.json': return import('shared').then(function (n) { return n.by; });
    case '../shared/translations/locales/et.json': return import('shared').then(function (n) { return n.bz; });
    ...
    case '../shared/translations/locales/ku.json': return import('shared').then(function (n) { return n.b_; });
    case '../shared/translations/locales/ky.json': return import('shared').then(function (n) { return n.b$; });
    case '../shared/translations/locales/lt.json': return import('shared').then(function (n) { return n.c0; });
    case '../shared/translations/locales/lv.json': return import('shared').then(function (n) { return n.c1; });
    case '../shared/translations/locales/mk.json': return import('shared').then(function (n) { return n.c2; });
    case '../shared/translations/locales/mn.json': return import('shared').then(function (n) { return n.c3; });
    case '../shared/translations/locales/ms.json': return import('shared').then(function (n) { return n.c4; });
    case '../shared/translations/locales/mt.json': return import('shared').then(function (n) { return n.c5; });
    case '../shared/translations/locales/my.json': return import('shared').then(function (n) { return n.c6; });
    case '../shared/translations/locales/ne.json': return import('shared').then(function (n) { return n.c7; });
    case '../shared/translations/locales/nl-be.json': return import('shared').then(function (n) { return n.c8; });
    case '../shared/translations/locales/nl.json': return import('shared').then(function (n) { return n.c9; });
    case '../shared/translations/locales/no.json': return import('shared').then(function (n) { return n.ca; });
    case '../shared/translations/locales/pl.json': return import('shared').then(function (n) { return n.cb; });
    case '../shared/translations/locales/pt-br.json': return import('shared').then(function (n) { return n.cc; });
    case '../shared/translations/locales/pt.json': return import('shared').then(function (n) { return n.cd; });
    case '../shared/translations/locales/ro-md.json': return import('shared').then(function (n) { return n.ce; });
    case '../shared/translations/locales/ro.json': return import('shared').then(function (n) { return n.cf; });
    case '../shared/translations/locales/ru.json': return import('shared').then(function (n) { return n.cg; });
    case '../shared/translations/locales/si.json': return import('shared').then(function (n) { return n.ch; });
    case '../shared/translations/locales/sk.json': return import('shared').then(function (n) { return n.ci; });
    case '../shared/translations/locales/sl.json': return import('shared').then(function (n) { return n.cj; });
    case '../shared/translations/locales/sq.json': return import('shared').then(function (n) { return n.ck; });
    case '../shared/translations/locales/sr-me.json': return import('shared').then(function (n) { return n.cl; });
    case '../shared/translations/locales/sr.json': return import('shared').then(function (n) { return n.cm; });
    case '../shared/translations/locales/sv.json': return import('shared').then(function (n) { return n.cn; });
    case '../shared/translations/locales/sw-ke.json': return import('shared').then(function (n) { return n.co; });
    case '../shared/translations/locales/ta.json': return import('shared').then(function (n) { return n.cp; });
    case '../shared/translations/locales/th.json': return import('shared').then(function (n) { return n.cq; });
    case '../shared/translations/locales/tr.json': return import('shared').then(function (n) { return n.cr; });
    case '../shared/translations/locales/uk.json': return import('shared').then(function (n) { return n.cs; });
    case '../shared/translations/locales/ur-pk.json': return import('shared').then(function (n) { return n.ct; });
    case '../shared/translations/locales/ur.json': return import('shared').then(function (n) { return n.cu; });
    case '../shared/translations/locales/uz.json': return import('shared').then(function (n) { return n.cv; });
    case '../shared/translations/locales/vi.json': return import('shared').then(function (n) { return n.cw; });
    case '../shared/translations/locales/zh-cn.json': return import('shared').then(function (n) { return n.cx; });
    case '../shared/translations/locales/zh-tw.json': return import('shared').then(function (n) { return n.cy; });
...
async function renderRequestList(container, data) {
    const { theme: { settings }, user: { locale }, pushNotification, hasCustomStatusesEnabled, } = data;
    initI18next(locale);
    ...
    ReactDOM.render(jsxRuntimeExports.jsx(ShadowRootContainer, { mode: inCypress ? "open" : "closed", "data-test-id": inCypress ? "guide-requests-app" : undefined, children: jsxRuntimeExports.jsx(ThemeProviders, { theme: createTheme(settings), children: jsxRuntimeExports.jsx(ErrorBoundary, { helpCenterPath: helpCenterPath, children: jsxRuntimeExports.jsx(PushNotificationContext.Provider, { value: pushNotification, children: jsxRuntimeExports.jsx(RequestsList, { locale: locale, customStatusesEnabled: hasCustomStatusesEnabled }) }) }) }) }), container);
}
